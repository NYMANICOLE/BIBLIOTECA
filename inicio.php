    ...
    <div class="wrapper">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><span class="icofont-Biblioteca mr-3 h4 text-white"></span>Libros<i class="icofont-rounded-down text-white"></i></a>
                ...
                <div class="col-md-5 col-lg-3 p-0 p-1">
                    <div class="row no-gutters bg-white shadow-sm">
                        <div class="col-md-3 bg-danger p-3">
                            <span class="icofont-ry h1 text-white"></span>
                        </div>
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br>
                    <small>Barrio: Ensueño</small>
                    <br>
                    <small>Calle: A15</small>
                    <br>
                    <small>Número: 15</small>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br>
                    <small>Email: yendinicole123@gmail.com</small>
                    <br>
                  </div>
                </div>
              </div>
